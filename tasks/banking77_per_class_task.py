"""BANKING77 with k-per-class balanced fewshot. num_fewshot = k per class."""
import sys, os; sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import random
import logging
from collections import defaultdict
from banking77_task import Banking77Task

_logger = logging.getLogger(__name__)


class Banking77PerClass(Banking77Task):

    def __init__(self, **kwargs):
        kwargs.pop("task", None)
        super().__init__(**kwargs)
        self.config.task = "banking77_per_class"
