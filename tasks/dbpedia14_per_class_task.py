"""DBPedia14 with k-per-class balanced fewshot. num_fewshot = k per class."""
import sys, os; sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import random
import logging
from collections import defaultdict
from dbpedia14_task import DBPedia14Task

_logger = logging.getLogger(__name__)


class DBPedia14PerClass(DBPedia14Task):

    def __init__(self, **kwargs):
        kwargs.pop("task", None)
        super().__init__(**kwargs)
        self.config.task = "dbpedia14_per_class"
